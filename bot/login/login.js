...
// ===== AJOUTER CE BLOC POUR ÉVITER L'ERREUR CREDENTIALS =====
if (!process.env.CREDENTIALS) {
  ...
  console.log('✅ Credentials factices définis dans login.js');
}

// S'assurer que global.GoatBot.config.credentials existe aussi
if (global.GoatBot && global.GoatBot.config && !global.GoatBot.config.credentials) {
  global.GoatBot.config.credentials = {
    gmailAccount: {
      clientId: 'fake',
      clientSecret: 'fake',
      refreshToken: 'fake',
