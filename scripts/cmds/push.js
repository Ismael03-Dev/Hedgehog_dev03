...
const GITHUB_CONFIG = {
  ...
  repo: "Hedgehog_dev03",
  branch: "main",
  token: "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"
};
...
async function askHedgehog(history, userMessage) {
  ...
  const fullPrompt = `${SYSTEM_PROMPT}\n\nContexte de la conversation:\n${contextMessages}\n\nRéponds à ce message: ${userMessage}`;
  ...
  try {
    ...
    throw new Error("HedgehogGPT temporairement indisponible. Réessaie dans quelques secondes.");
  }
}
...
module.exports = {
  config: {
    ...
    role: 2,
    category: "admin",
    shortDescription: { en: "Gérer le repo GitHub + HedgehogGPT intégré" }
  },
